...
# Fix: In production the secret key should be kept secret and defined in an environment variable.
SECRET_KEY = "django-insecure-lk6tvnuizw6v$e@s8zfefwn_l*ap2b*0@&ld0j^l3q7@x&&y6d"

# SECURITY WARNING: don't run with debug turned on in production!
# Flaw 4: Security Misconfiguration
# Fix: In production the DEBUG should be set to False.
DEBUG = True
